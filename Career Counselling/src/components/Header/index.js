...
const styles = theme => ({
  toolbar: { 
    ...
    background: '-webkit-linear-gradient(360deg, #1C1C1C 10%, #494949 360%)', background: '-moz-linear-gradient(360deg, #1C1C1C 10%, #494949 360%)', background:' linear-gradient(360deg, #1C1C1C 10%, #494949 360%)',
   // background: 'linear-gradient(to top, #040507, #010817, #020921, #05092b, #0a0834)', // chnage
    //background: 'linear-gradient(to right, #0b0c10, #282b34, #444a5c, #616d87, #8091b4, #7696ba, #6b9bbe, #5ea0c0, #2d8392, #096563, #044736, #082a0e)',
   // background: 'linear-gradient(to left, #0b0c10, #0e101b, #0f1424, #0e172e, #0d1a38, #0b2142, #07294b, #003155, #003f5d, #004c61, #005861, #11645f)',
          ...
          <Toolbar className={classes.toolbar}>
            ...
            > 
              ...
              >
                ...
                <div className={classes.title}> <strong style={{
                                 fontSize:'1.6em',
                                 letterSpacing:'1.7px',
                                // fontFamily:'monospace',
                                  fontWeight: 'bold'
                          
                }}>  Career Counselling   </strong> </div>
              </Link>
            </Typography>
            {showSearchButton && (
              <Button
